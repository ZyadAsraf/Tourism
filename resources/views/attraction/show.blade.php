          ...
          <div class="mb-8">
              ...
              <div class="grid grid-cols-3 gap-4">
                  @foreach($attraction['gallery'] as $image)
                      <img src="{{ $image }}" alt="{{ $attraction['title'] }}" class="rounded-lg h-32 w-full object-cover">
                  @endforeach
              </div>
          </div>
          @endif
      ...
      <div class="mb-12">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
              @foreach($related as $relatedAttraction)
                  <div class="card">
                      <div class="relative">
                          <img src="{{ $relatedAttraction['image'] }}" alt="{{ $relatedAttraction['title'] }}" class="w-full h-48 object-cover">
                      ...
                      <div class="p-4">
                          ...
                          <a href="{{ route('attractions.show', $relatedAttraction['slug']) }}" class="btn-primary w-full">View Details</a>
                      </div>
                  </div>
              @endforeach
          </div>
