...
<head>
    ...
    <title>@yield('title', 'TravelEgypt - Discover Egypt\'s Hidden Gems')</title>
    <link href="https://cdn.jsdelivr.net/npm/tailwindcss@2.2.19/dist/tailwind.min.css" rel="stylesheet">
    <style>
        :root {
            --color-primary: #d2ac71;
            --color-primary-dark: #c19c61;
            --color-bg: #f6efe6;
            --color-text: #717171;
    ...
    <div class="container mx-auto px-4 py-8">
        <header class="flex justify-between items-center mb-8">
            <div class="flex items-center gap-2">
                <a href="{{ route('home') }}">
                    <img src="/images/logo.svg" alt="Tourism App Logo" class="w-10 h-10 rounded-full">
                </a>
                <h1 class="text-2xl font-bold text-primary">
                    <a href="{{ route('home') }}">TravelEgypt</a>
                </h1>
            </div>
        ...
        <footer class="mt-12 py-6 border-t border-gray-200">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                <div>
                    <h3 class="font-bold text-lg mb-4">TravelEgypt</h3>
            ...
            <div class="border-t border-gray-200 pt-6 flex flex-col md:flex-row justify-between items-center">
                <p class="text-sm text-gray-500">&copy; {{ date('Y') }} TravelEgypt. All rights reserved.</p>
