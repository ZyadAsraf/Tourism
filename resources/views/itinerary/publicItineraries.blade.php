...
@section('title', 'Public Itineraries')

@section('content')
<div class="mb-8">
    <h1 class="text-3xl font-bold text-gray-600 mb-2">Public Itineraries</h1>
    <p class="text-gray-500">Discover travel plans created by our community</p>
</div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            @empty
                <div class="col-span-3 text-center py-12">
                    ...
                    <p class="text-gray-500 mb-6">There are currently no public itineraries available with the selected filters. Please try different filters or check back later.</p>
                    @if(request()->has('type') || request()->has('query'))
